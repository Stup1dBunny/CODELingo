window.registerTheme({
  ...
  questions: [
    // ================= 1. LINUX НА УРОВНЕ СИСТЕМНОГО АДМИНИСТРАТОРА =================
    {
      ...
      q: 'Что такое Linux?',
      a: 'Семейство Unix-подобных операционных систем на базе ядра Linux. Ядро управляет процессами, памятью, устройствами и файловой системой. Дистрибутивы добавляют пакетный менеджер и утилиты.',
